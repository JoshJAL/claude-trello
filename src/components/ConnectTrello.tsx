  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        disabled={loading}
        className="flex items-center justify-center gap-2 rounded-md bg-[#0079BF] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#026AA7] disabled:opacity-50"
      >
