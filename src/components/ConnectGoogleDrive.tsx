  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        disabled={loading}
        className="flex items-center justify-center gap-2 rounded-md bg-[#4285f4] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#3367d6] disabled:opacity-50"
      >
