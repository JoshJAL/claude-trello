  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        disabled={loading}
        className="flex items-center justify-center gap-2 rounded-md bg-[#24292f] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#1b1f23] disabled:opacity-50 dark:bg-[#f0f6fc] dark:text-[#24292f] dark:hover:bg-[#d0d7de]"
      >
